export default class CustomContextPadProvider {
  ...
  static $inject = ["connect", "contextPad", "modeling", "elementFactory", "create", "popupMenu", "idCounterService", "selection", "simulationService"];

  constructor(connect, contextPad, modeling, elementFactory, create, popupMenu, idCounterService, selection, simulationService) {
