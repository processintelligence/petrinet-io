export default class Sugiyama {
    ...
    static $inject = ["cycleRemoval", "layerAssignment",
        "dummyInsertion", "vertexOrdering", "coordinateAssigment", "edgeRouting"];
    ...
    layout (petriNet) {
        ...
        const restoredPN = this.cycleRemoval.restoreCycles(coordinateAssigmentPN);
        const routedPN = this.edgeRouting.route(restoredPN);
